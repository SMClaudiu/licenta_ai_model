...
class TaskDataProcessor:
    ...
    def engineer_advanced_features(self , df , fit_mode=False):
    ...
    def get_processed_data(self , task_type='classification'):
        ...
        df = self.engineer_advanced_features(df , fit_mode=True)
        if task_type == 'classification':
    ...
    def load_preprocessors(self , filepath='enhanced_preprocessors.pkl'):
        ...
        self.global_averages = preprocessors.get('global_averages' , { })
        self.frequency_maps = preprocessors.get('frequency_maps' , { })
        self.quantiles = preprocessors.get('quantiles' , { })
...
class TaskDatasetFactory:
    ...
    def create_datasets(self , x , y , test_size , val_size , batch_size , task_type , use_stratification):
        ...
        return {
            ...
            'feature_names':self.data_processor.feature_names , 'num_features':x_train.shape[1] ,
